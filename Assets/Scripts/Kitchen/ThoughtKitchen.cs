...
public class ThoughtKitchen : MonoBehaviour {
    ...
    private string[] Thoughts = { "Кто-то не экономит электричество!","Я не могу уйти, пока не выключу приборы.",
        "Но я хочу кушать.", "Это здорово, но что тут кушать?","Может откроем ее?","Еду нужно подогреть!","Вкусненько!",
        "В микроволновке нельзя такое греть!","Может закроем холодильник?" };
